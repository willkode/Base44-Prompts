...
source_file: "affiliateSystem.js"
---

# Build a Complete Affiliate System (USA + Canada, 90-Day Cookie, Monthly Payouts)

> Add a full affiliate program to your existing Base44 app — signup, 90-day cookie tracking, attribution, conversion tracking, affiliate dashboard, admin dashboard, monthly payouts, fraud prevention, and admin approval workflow. USA + Canada eligibility built in.

**Category:** App Building  
**Published:** 2026-04-29  
**Source File:** `affiliateSystem.js`
